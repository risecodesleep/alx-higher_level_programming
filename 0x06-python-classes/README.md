...
| `100-singly_linked_list.py` | Class `Node` that defines a node of a singly linked list and a Class `SinglyLinkedList` that represents a singly linked list of `Node` objects |
...
| `103-python.c` | Python Class that does exactly the same as a Python bytecode provided |
